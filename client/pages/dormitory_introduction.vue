  ...
  <div class="row">
    <div class="col-xs-12" style="background:#ebebeb;height: 100%;">
      ...
      <div class="col-xs-12">
        ...
        <div class="row">
          <div class="col-sm-5 col-xs-12">
            <p>宮崎大学国際交流宿舎(以下国寮)は宮崎大学木花キャンパスにある学生寮です。寮の自治も寮生が行っています。</p>
            <p>大きな特徴は、日本人と外国人留学生が住んでいるということです。隣の部屋に外国人が住んでいることは国寮において全く珍しいことではありません。捕食室や談話室といった共用スペースもあるので、外国人留学生とのコミュニケーションも積極的に行えます。</p>
          </div>
          <div class="col-sm-7 col-xs-12">
            ...
            >
              <img
                src="images/dormitory/dormitory.jpg"
      ...
      <div class="col-xs-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <strong>☆友達ができやすい！</strong>
          </div>
          <div class="panel-body">各階でつながりがあるだけでなく、月一でイベント(任意参加)もおこなっているので、大学で友達ができるか不安な人も安心です。</div>
        </div>
        <div class="panel panel-default">
          <div class="panel-heading">
            <strong>☆いろんな分野の人がいる！</strong>
          </div>
          <div
            class="panel-body"
          >現在、教育学部・地域創生学部・農学部・工学部・医学部と、全ての学部の学生がいます。自分の得意でない分野の話を他の寮生から聞くことができるので、知見を広げることができます。</div>
        </div>
        <div class="panel panel-default">
          <div class="panel-heading">
            <strong>☆外国人留学生と交流しやすい！</strong>
          </div>
          <div
            class="panel-body"
          >外国の文化に興味がある、普段から英会話をしたいなどを考えている人にはとてもオススメです。寮生の約1/3が外国人留学生です。積極的に交流するチャンスが国寮にはあります。</div>
        </div>
      </div>
          ...
          <div class="col-lg-6 col-xs-12">
            <div class="row">
              <div class="col-sm-4 col-xs-4">
                <a
                  href="images/dormitory/room1.jpg"
                  data-lightbox="image"
                  data-title="居室1"
                ...
                >
                  <img
                    src="images/dormitory/room1.jpg"
                    class="img-responsive img-rounded"
                    alt="居室1"
                  >
                </a>
              ...
              <div class="col-sm-4 col-xs-4">
                <a
                  href="images/dormitory/room2.jpg"
                  data-lightbox="image"
                  data-title="居室2"
                ...
                >
                  <img
                    src="images/dormitory/room2.jpg"
                    class="img-responsive img-rounded"
                    alt="居室2"
                  >
                </a>
              ...
              <div class="col-sm-4 col-xs-4">
                <a
                  href="images/dormitory/toile.jpg"
                  data-lightbox="image"
                  data-title="トイレ"
                ...
                >
                  <img
                    src="images/dormitory/toile.jpg"
                    class="img-responsive img-rounded"
                    alt="トイレ"
                  >
                </a>
          ...
          <div class="col-lg-6 col-xs-12">
            ...
            <div class="row">
              <div class="col-sm-6 col-xs-12">
                ...
                >
                  <img
                    src="images/dormitory/hosyoku.jpg"
                    class="img-responsive img-rounded"
                    alt="補食室"
                  >
                </a>
          ...
          <div class="col-lg-6 col-xs-12">
            ...
            <div class="row">
              <div class="col-sm-6 col-xs-12">
                ...
                >
                  <img
                    src="images/dormitory/kitchen.jpg"
                    class="img-responsive img-rounded"
                    alt="キッチン"
                  >
                </a>
          ...
          <div class="col-lg-6 col-xs-12">
            ...
            <div class="row">
              <div class="col-sm-6 col-xs-12">
                ...
                >
                  <img
                    src="images/dormitory/danwa.jpg"
                    class="img-responsive img-rounded"
                    alt="談話室"
                  >
                </a>
          ...
          <div class="col-lg-6 col-xs-12">
            ...
            <div class="row">
              <div class="col-sm-6 col-xs-12">
                ...
                >
                  <img
                    src="images/dormitory/sentaku.jpg"
                    class="img-responsive img-rounded"
                    alt="洗濯室"
                  >
                </a>
        ...
        <div class="col-md-4 col-xs-12">
          ...
          <div class="row">
            <div class="col-md-6 col-xs-6">
              ...
              >
                <img
                  src="images/dormitory/parking2.jpg"
                  class="img-responsive img-rounded"
                  alt="駐輪場"
                >駐輪場
              </a>
            ...
            <div class="col-md-6 col-xs-6">
              ...
              >
                <img
                  src="images/dormitory/parking.jpg"
                  class="img-responsive img-rounded"
                  alt="駐車場"
                >駐車場
              </a>
      ...
      <div class="col-xs-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">Q. 門限はありますか？</div>
          <div class="panel-body">A. ありません。いつでも帰ってこれます。</div>
        </div>
        <div class="panel panel-default">
          <div class="panel-heading">Q. 就寝時刻はありますか？</div>
          <div class="panel-body">A. ありません。ただし、他の人の迷惑にならないようにしましょう。</div>
        </div>
        <div class="panel panel-default">
          <div class="panel-heading">Q. お風呂はいつでも入れますか？</div>
          <div class="panel-body">A. 24時間いつでも入れます。</div>
        </div>
        <div class="panel panel-default">
          <div class="panel-heading">Q. 食堂はありますか？</div>
          <div class="panel-body">A. 補食室で自主的に料理をすることはできますが、いわゆる食堂はありません。しかし、大学の食堂（生協）に徒歩5分で行けます。</div>
        </div>
        <div class="panel panel-default">
          <div class="panel-heading">Q. 盗難はありますか？</div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">Q. 寮母さんはいますか？</div>
          <div class="panel-body">
            A.
        ...
        <div class="panel panel-default">
          <div class="panel-heading">Q. ネット環境はどうなっていますか？</div>
          <div class="panel-body">
            A.
        ...
        <div class="panel panel-default">
          <div class="panel-heading">Q. 上下関係は厳しいですか？</div>
          <div class="panel-body">
            A.
        ...
        <div class="panel panel-default">
          <div class="panel-heading">Q. 寮生同士の雰囲気はどんな感じですか？</div>
          <div class="panel-body">
            A.
      ...
      <div class="col-xs-12">
        ...
        <ul>
          <li>
            宮崎大学学生生活支援部の寮に関するページ →
            <a
              href="http://gakumu.of.miyazaki-u.ac.jp/gakumu/campuslifeinfo/campuslife/dormitory/dormitory.html"
              target="_blank"
              onClick="ga('send', 'event', 'link', 'dormitory', 'shienka')"
            >学生寮・下宿・アパートの概要</a>
          </li>
          <li>
            宮崎大学国際交流宿舎への地図 →
            <a
              href="https://goo.gl/maps/VD1EFFxC1w72"
              target="_blank"
              onClick="ga('send', 'event', 'link', 'dormitory', 'googlemap')"
            >
              google
              map
            </a>
      ...
      <div class="col-xs-12">
        <h2>みんなで作る、国寮ページ</h2>もし、このページに矛盾点、改善点等がある場合、以下の方法で貢献できます。
        <ul>
          <li>
            githubにissueを飛ばす。もしくは、forkしてプルリクエストを送る。 →
            <a
