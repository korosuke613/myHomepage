    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12" style="background:#AAA;height:auto;">
                ...
                <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-7246355771451460" data-ad-slot="1166933944"
                ...
                <div class="text-center">
                    ...
                    <a href="http://mplus-fonts.osdn.jp/" target="_blank" onClick="ga('send', 'event', 'link', 'fonts', 'mplus')"
                        class="footLink">M+ FONTS</a><br> icons: <a href="http://fontawesome.io/icons/" target="_blank"
                        onClick="ga('send', 'event', 'link', 'icons', 'fontawesome')" class="footLink">Font Awesome</a>
                </div>
                <br>
                <div style="font-family: 'Anton',sans-serif;" class="text-right">
                    ©2017 Futa HIRAKOBA inc.
                </div>
            </div>
        </div>
    </div>
