    ...
    $.ajax({
      ...
      success: function(html) {
        ...
        $(html)
          .find("#activity")
          .each(function() {
            //読み込みたい部分の指定　今回は#demo_blockの中身が読み込まれる
        ...
        $("#writes br:gt(3)").remove(); //4件目以降の br を削除
          ...
          <div class="col-sm-12">
            ...
            <div class="row">
              <div class="col-xs-3">
                <a
                  href="images/aoshima.jpg"
                  data-lightbox="image"
                  data-title="サンメッセ日南"
                  onClick="ga('send', 'event', 'photo', 'photo', 'sanmesse')"
                  class="photo"
                >
              ...
              <div class="col-xs-3">
                <a
                  href="images/fushimi.jpg"
                  data-lightbox="image"
                  data-title="伏見稲荷神社"
                  onClick="ga('send', 'event', 'photo', 'photo', 'hushimi')"
                  class="photo"
                >
              ...
              <div class="col-xs-3">
                <a
                  href="images/takatiho.jpg"
                  data-lightbox="image"
                  data-title="高千穂峡"
                  onClick="ga('send', 'event', 'photo', 'photo', 'takachiho')"
                  class="photo"
                >
              ...
              <div class="col-xs-3">
                <a
                  href="images/kirishima.jpg"
                  data-lightbox="image"
                  data-title="霧島"
                  onClick="ga('send', 'event', 'photo', 'photo', 'kirishima')"
                  class="photo"
                >
